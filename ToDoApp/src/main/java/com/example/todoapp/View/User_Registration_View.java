...
public class User_Registration_View extends Div {
    public User_Registration_View(UserService service) {
        ...
        registration_Btn.addClickListener(clickEvent -> {
            try {
                ...
                User user = new User(get_name,get_username,get_pssword);
                service.add(user);
